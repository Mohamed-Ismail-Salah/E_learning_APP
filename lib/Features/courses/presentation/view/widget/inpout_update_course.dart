...
import 'package:e_learning/Features/courses/presentation/view_models/update_courses_cubit/update_courses_cubit.dart';
...
class InPoutUpdateCourse extends StatelessWidget {
  const InPoutUpdateCourse({super.key});
              ...
              child: CustomButton(
                ...
                onTap: () {
                  if (formKey.currentState?.validate() == true) {
                    ...
                    // BlocProvider.of<UpdateCoursesCubit>(context).updateCourses(
                    //
                    //     subjectName!,
                    //     levelCourse!,
                    //     termCourse!,
